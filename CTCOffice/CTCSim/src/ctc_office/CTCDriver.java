...
public class CTCDriver {
	 ...
	 */
	 public boolean runCTC() {
	   ...
	   for (TrackLayout t : lines.values()) {
	       ...
	       // t.dispatchNewTrains(); // from the scheduler
	...
	public void routeTrains(String lineName) {
		lines.get(lineName).getUpdatedTrainRoutes();		
	}
	 ...
	 */
	public boolean setTrackLayout(String lineName, DirectedMultigraph<Integer, DefaultEdge> layout, List<TrackBlock> blockData) {
		lines.put(lineName, new TrackLayout(layout, blockData, lineName));
