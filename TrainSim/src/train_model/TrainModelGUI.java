...
public class TrainModelGUI extends JFrame {
	...
	public TrainModelGUI(boolean mode) {
		...
		gbl_contentPane.columnWidths = new int[]{1, 145, 47, 478, 0};
		gbl_contentPane.rowHeights = new int[]{1, 16, 16, 27, 16, 16, 16, 29, 29, 29, 29, 29, 29, 16, 16, 28, 29, 16, 16, 16, 16, 16, 0};
		...
		gbc_lblTrainModelInterface.gridx = 1;
		gbc_lblTrainModelInterface.gridy = 1;
		...
		gbc_lblTrainModelSelector.gridx = 3;
		gbc_lblTrainModelSelector.gridy = 2;
		...
		gbc_currPowLabel.gridx = 2;
		gbc_currPowLabel.gridy = 4;
		...
		gbc_currForceLabel.gridx = 2;
		gbc_currForceLabel.gridy = 5;
		...
		gbc_lblSimulationControls.gridx = 3;
		gbc_lblSimulationControls.gridy = 5;
		...
		gbc_currAccelLabel.gridx = 2;
		gbc_currAccelLabel.gridy = 6;
		...
		gbc_currVelocityLabel.gridx = 2;
		gbc_currVelocityLabel.gridy = 7;
		...
		gbc_btnEngineFailure.gridx = 3;
		gbc_btnEngineFailure.gridy = 7;
		...
		gbc_currPositionLabel.gridx = 2;
		gbc_currPositionLabel.gridy = 8;
		...
		gbc_btnRestoreEngine.gridx = 3;
		gbc_btnRestoreEngine.gridy = 8;
		...
		gbc_btnBrakeFailure.gridx = 3;
		gbc_btnBrakeFailure.gridy = 9;
		...
		gbc_lblPassengerCount.gridy = 10;
		...
		gbc_crewCountLabel.gridx = 2;
		gbc_crewCountLabel.gridy = 10;
		...
		gbc_btnRestoreBrakes.gridx = 3;
		gbc_btnRestoreBrakes.gridy = 10;
		...
		gbc_passCountLabel.gridx = 2;
		gbc_passCountLabel.gridy = 11;
		...
		gbc_btnSigPickupFailure.gridx = 3;
		gbc_btnSigPickupFailure.gridy = 11;
		...
		gbc_btnRestoreSigPickup.gridx = 3;
		gbc_btnRestoreSigPickup.gridy = 12;
		...
		gbc_leftDoorLabel.gridx = 2;
		gbc_leftDoorLabel.gridy = 13;
		...
		gbc_rightDoorLabel.gridx = 2;
		gbc_rightDoorLabel.gridy = 14;
		...
		gbc_lblSetPowerCommand.gridx = 3;
		gbc_lblSetPowerCommand.gridy = 14;
		...
		gbc_lightsLabel.gridx = 2;
		gbc_lightsLabel.gridy = 15;
		...
		gbc_txtSetPower.gridx = 3;
		gbc_txtSetPower.gridy = 15;
		...
		gbc_lblBeacon.gridx = 1;
		gbc_lblBeacon.gridy = 16;
		...
		gbc_beaconLabel.gridx = 2;
		gbc_beaconLabel.gridy = 16;
		...
		gbc_btnSetPower.gridx = 3;
		gbc_btnSetPower.gridy = 16;
		...
		gbc_sBrakeLabel.gridx = 2;
		gbc_sBrakeLabel.gridy = 17;
		...
		gbc_lblEmergencyBrake.gridy = 18;
		...
		gbc_eBrakeLabel.gridx = 2;
		gbc_eBrakeLabel.gridy = 18;
		...
		gbc_lblEngineStatus.gridx = 1;
		gbc_lblEngineStatus.gridy = 19;
		...
		gbc_engineStatusLabel.gridx = 2;
		gbc_engineStatusLabel.gridy = 19;
		...
		gbc_lblBrakeStatus.gridx = 1;
		gbc_lblBrakeStatus.gridy = 20;
		...
		gbc_brakeStatusLabel.gridx = 2;
		gbc_brakeStatusLabel.gridy = 20;
		...
		gbc_lblSignalPickupStatus.insets = new Insets(0, 0, 0, 5);
		gbc_lblSignalPickupStatus.gridx = 1;
		gbc_lblSignalPickupStatus.gridy = 21;
		...
		gbc_sigPickupLabel.insets = new Insets(0, 0, 0, 5);
		gbc_sigPickupLabel.gridx = 2;
		gbc_sigPickupLabel.gridy = 21;
