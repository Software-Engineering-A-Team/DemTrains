...
public class CTCGUI extends JFrame{
	...
	public CTCGUI() {
		...
		JLabel lblDesiredThroughput = new JLabel("Desired Throughput");
		panel.add(lblDesiredThroughput);
		
		throughput = new JTextField();
		throughput.setText("10");
		panel.add(throughput);
		throughput.setColumns(10);
