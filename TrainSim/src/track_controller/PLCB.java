...
public class PLCB implements PLCInterface {
	private HashMap<Integer, TrackBlock> controlledBlocks;
	
	public PLCB(HashMap<Integer, TrackBlock> blockList){
	...
	public boolean ctrlCrossing() {
		//if any of affected blocks are occupied, its active
		if(controlledBlocks.get(50).occupancy || controlledBlocks.get(49).occupancy || controlledBlocks.get(48).occupancy ||
				controlledBlocks.get(66).occupancy || controlledBlocks.get(67).occupancy || controlledBlocks.get(46).occupancy ||
				controlledBlocks.get(45).occupancy || controlledBlocks.get(44).occupancy){
			return true;
		}
		//otherwise inactive
		else return false;
	...
	public boolean ctrlSwitch(TrainRoute r) {
		TrackSwitch relSwitch = (TrackSwitch) controlledBlocks.get(27);
		TrackSwitch relSwitch2 = (TrackSwitch) controlledBlocks.get(32);
